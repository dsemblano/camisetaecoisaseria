<section class="blockhome-3 flex flex-col md:flex-row justify-between mt-0 md:mt-12">
  <div class="blockhome-3-left self-center order-1 m-auto pt-0 md:pt-16 pb-2 text-center leading-loose">
      <h2 class="text-5xl text-pureblack">Faça sua Nós</h2>

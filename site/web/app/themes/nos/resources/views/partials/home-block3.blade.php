<section class="blockhome-3 container flex flex-col md:flex-row justify-between mt-0 md:mt-12 mb-12">
  <div class="blockhome-3-left m-auto mt-8 md:mt-0 mb-8 self-center order-1 text-center leading-none">
